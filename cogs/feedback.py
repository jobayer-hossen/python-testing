...
class FeedbackCog(commands.Cog):
    ...
    # Commands
    @bridge.bridge_command(name='complaint', aliases=('complain',), description='Sends a complaint about Epic Navi to the owner.')
    async def complaint(
        self,
    ...
    @bridge.bridge_command(name='suggestion', aliases=('suggest',), description='Sends a suggestion about Epic Navi to the owner.')
