...
async def embed_help(bot: bridge.AutoShardedBot, ctx: bridge.BridgeContext | discord.Message) -> discord.Embed:
    ...
    misc_settings = (
        ...
        f'{emojis.BP} **[About Epic Navi]({title_link})**: '
...
async def embed_about(bot: bridge.AutoShardedBot, ctx: bridge.BridgeContext, api_latency: timedelta) -> tuple[discord.File, discord.Embed]:
    ...
    img_navi: discord.File = discord.File(settings.IMG_NAVI, filename='epicNavi.png')
    image_url: str = 'attachment://epicNavi.png'
    embed: discord.Embed = discord.Embed(
        color = settings.EMBED_COLOR,
        title = 'ABOUT EPIC NAVI' if not settings.LITE_MODE else 'ABOUT EPIC NAVI LITE',
